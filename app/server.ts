...
process.env.NODE_CONFIG_DIR = 'constants'; ///////////For local test only, remove this before deployment
process.env.NODE_ENV = 'test'; ///////////For local test only, remove this before deployment
...
console.info("The NODE_CONFIG_DIR is: "+process.env.NODE_CONFIG_DIR);
...
QueueApi.startLongPoll(ImageService.createHandler, true);  ///////////For local test only, remove this before deployment
OutboundService.startTasksWatcher(true); ///////////For local test only, remove this before deployment
ImageStatusCheckerService.run(true)  ///////////For local test only, remove this before deployment
